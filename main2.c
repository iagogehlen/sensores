...
int main() {
    ...
    pthread_create(&leitura1, NULL, threadLeitura, "mqtt_senzemo_cx_bg.json");

    pthread_create(&leitura2, NULL, threadLeitura, "senzemo_cx_bg.json");

    pthread_create(&processamento, NULL, threadProcessamento, NULL);

    pthread_create(&logger, NULL, threadLogger, NULL);
